...
class SMAgent(Agent):
    ...
    def getAction(self, state):
        ...
        #Production system
        if w[1] & (not w[3]): return Directions.EAST
        elif w[3] & (not w[5]): return Directions.SOUTH
        elif w[5] & (not w[7]): return Directions.WEST
        elif w[7] & (not w[1]): return Directions.NORTH

        elif w[0]: return Directions.NORTH
        elif w[2]: return Directions.EAST
        elif w[4]: return Directions.SOUTH
        elif w[6]: return Directions.WEST
